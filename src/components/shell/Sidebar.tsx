  ...
  return (
    <aside className="shell-sidebar">
      <div className="shell-sidebar__brand">
        <span className="shell-sidebar__mark" aria-hidden="true">
          P
        </span>
        <span>PortPal</span>
      </div>
...
function PortsIcon() {
  return (
    <svg viewBox="0 0 18 18">
      ...
      <path d="M5 9h.01M9 9h.01M13 9h.01" />
    </svg>
  );
}
...
function SettingsIcon() {
  return (
    <svg viewBox="0 0 18 18">
      ...
      <path d="M9 2v2m0 10v2m7-7h-2M4 9H2m12-5.5-1.4 1.4M5.4 12.6 4 14m10 0-1.4-1.4M5.4 5.4 4 4" />
    </svg>
  );
}
