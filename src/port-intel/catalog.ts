...
export const PORT_CATALOG: Record<number, PortFacts> = {
  ...
  80: {
    ...
    protocol: 'HTTP',
    category: 'web',
    description: 'The standard port for unencrypted web pages. A browser visiting an address that starts with "http://" and has no port number lands here.',
    context: 'Normal for a local web server. Traffic on it is not encrypted, so public websites use port 443 instead.',
  ...
  443: {
    ...
    protocol: 'HTTPS',
    category: 'web',
    description: 'The standard port for encrypted web pages. This is what the padlock in a browser address bar refers to.',
  ...
  8080: {
    ...
    protocol: 'HTTP',
    category: 'web',
    description: 'A very common second choice for a web server, used when port 80 is taken or would need administrator rights. Popular with Java servers, proxies, and test environments.',
  ...
  8443: {
    ...
    protocol: 'HTTPS',
    category: 'web',
    description: 'The encrypted counterpart to port 8080, used when a server wants HTTPS without needing administrator privileges.',
  ...
  8008: {
    ...
    protocol: 'HTTP',
    category: 'web',
    description: 'Another fallback web port, used by some appliances, chat servers, and casting devices.',
  ...
  3000: {
    ...
    category: 'dev-server',
    description: 'The default port for React, Next.js, and many Node.js apps in development. Grafana dashboards also use it. This is what "npm start" usually opens.',
  ...
  3001: {
    ...
    category: 'dev-server',
    description: 'The automatic second choice when port 3000 is already busy. Often a second app, or an API running alongside a frontend.',
  ...
  3030: {
    ...
    protocol: 'Node.js',
    category: 'dev-server',
    description: 'A common alternative development port for Node.js tools such as Slidev and Meteor, and for hand-rolled API servers.',
  ...
  3333: {
    ...
    protocol: 'Node.js / Nx',
    category: 'dev-server',
    description: 'A frequently chosen development port for API servers, AdonisJS, and Nx workspaces.',
    context: 'Expected while a project is running.',
  ...
  4000: {
    ...
    category: 'dev-server',
    description: 'A common development port for Node.js APIs, GraphQL servers, Phoenix (Elixir) apps, and Jekyll sites.',
    context: 'Expected while a project is running.',
  ...
  4173: {
    ...
    category: 'dev-server',
    description: 'Vite serving a finished production build locally so you can check it before shipping. Started by "vite preview".',
  ...
  5000: {
    ...
    category: 'dev-server',
    description: 'The default for Python Flask apps and for ASP.NET Core. On macOS this port is also taken by the built-in AirPlay Receiver.',
    context: 'Expected while a project is running. On a Mac, an unexpected listener here is usually AirPlay rather than your own code.',
  ...
  5173: {
    ...
    protocol: 'Vite',
    category: 'dev-server',
    description: 'The default port for Vite, the build tool behind modern React, Vue, and Svelte projects. It reloads the page as you edit.',
    context: 'Expected while you are working on a project. Safe to stop when you are done.',
  ...
  5555: {
    ...
    category: 'dev-server',
    description: 'Prisma Studio, a web page for browsing and editing the contents of your database during development.',
  ...
  6006: {
    ...
    protocol: 'Storybook',
    category: 'dev-server',
    description: 'Storybook, a private web page listing your interface components so you can view and test them one at a time.',
  ...
  7000: {
    ...
    protocol: 'Various',
    category: 'dev-server',
    description: 'A general-purpose development port. On macOS it is also used by the AirPlay Receiver built into the system.',
    context: 'On a Mac, a listener here that you did not start is usually AirPlay, which can be turned off in System Settings.',
    aliases: ['airplay', 'dev'],
  },
  8000: {
    plainName: 'Development Server',
    ...
    category: 'dev-server',
    description: 'The default for the Django development server and for "python -m http.server". Also a common choice for PHP and Laravel.',
  ...
  8081: {
    ...
    category: 'dev-server',
    description: 'The Metro bundler for React Native, which builds and serves JavaScript to a phone or emulator. Also a common alternate web port.',
  ...
  8888: {
    ...
    protocol: 'Jupyter',
    category: 'dev-server',
    description: 'Jupyter Notebook or JupyterLab, a browser-based environment for running Python code in small blocks.',
    context: 'Expected if you started a notebook. Anyone who can reach this port can run code on this machine, so it should stay local.',
  ...
  9000: {
    ...
    category: 'dev-server',
    description: 'Most often PHP-FPM, the process that runs PHP code behind a web server. Also used by SonarQube, MinIO, and Portainer.',
  ...
  9229: {
    ...
    category: 'dev-server',
    description: 'The Node.js debugger. Your editor or Chrome DevTools connects here to pause code and inspect variables.',
    context: 'Expected when you started a program with "--inspect". Anyone who can reach it can run code, so it should stay on this machine only.',
  ...
  19000: {
    ...
    protocol: 'Expo',
    category: 'dev-server',
    description: 'The Expo development server for React Native apps, which your phone connects to while you test.',
  ...
  24678: {
    ...
    protocol: 'Vite HMR',
    category: 'dev-server',
    description: 'The background connection Vite uses to push code changes straight into your browser without a full page refresh.',
  ...
  35729: {
    ...
    protocol: 'LiveReload',
    category: 'dev-server',
    description: 'The LiveReload service, which refreshes your browser automatically whenever a file changes.',
  ...
  1420: {
    ...
    protocol: 'Tauri',
    category: 'dev-server',
    description: 'The development server Tauri uses to load the interface of a desktop app. PortPal itself uses this port while being developed.',
  ...
  5432: {
    ...
    protocol: 'PostgreSQL',
    category: 'database',
    description: 'PostgreSQL, a widely used database. Applications connect here to read and write their data.',
    context: 'Normal if you installed Postgres or run it in a container. Stopping it will disconnect anything using it.',
  ...
  5433: {
    ...
    protocol: 'PostgreSQL',
    category: 'database',
    description: 'A second PostgreSQL instance, commonly a different version or a container running next to the main one.',
  ...
  3306: {
    ...
    category: 'database',
    description: 'MySQL or MariaDB, a widely used database. Applications connect here to read and write their data.',
  ...
  6379: {
    ...
    protocol: 'Redis',
    category: 'database',
    description: 'Redis, a very fast in-memory store used for caching, sessions, and job queues. What it holds is usually temporary.',
    context: 'Normal in most modern app setups. Redis has no password by default, so it should not be reachable from outside this machine.',
  ...
  27017: {
    ...
    protocol: 'MongoDB',
    category: 'database',
    description: 'MongoDB, a document database that stores data as flexible JSON-like records rather than fixed tables.',
    context: 'Normal if your project uses MongoDB. It should stay local unless you deliberately opened it up.',
  ...
  9042: {
    ...
    category: 'database',
    description: 'Apache Cassandra, a database built to spread very large amounts of data across many machines.',
  ...
  7687: {
    ...
    protocol: 'Neo4j Bolt',
    category: 'database',
    description: 'Neo4j, a graph database that stores information as connected nodes and relationships.',
  ...
  8086: {
    ...
    protocol: 'InfluxDB',
    category: 'database',
    description: 'InfluxDB, a database specialised in time-stamped measurements such as metrics and sensor readings.',
  ...
  11211: {
    ...
    context: 'Normal in a caching setup. It has no authentication, so it should never be reachable from the internet.',
  ...
  9200: {
    ...
    category: 'database',
    description: 'Elasticsearch or OpenSearch, which indexes text and log data so it can be searched quickly.',
    context: 'Normal in search or logging setups. Older versions have no password by default, so it should stay local.',
  ...
  9300: {
    ...
    category: 'database',
    description: 'The private channel Elasticsearch servers use to talk to each other. Applications use port 9200 instead.',
  ...
  25: {
    ...
    context: 'Unusual on a personal machine. Most internet providers block it, and modern mail apps use port 587 instead.',
  ...
  587: {
    ...
    category: 'mail',
    description: 'The standard modern port an email program uses to hand a message to its mail server.',
    context: 'Normal for a configured mail client or mail server.',
  ...
  110: {
    ...
    protocol: 'POP3',
    category: 'mail',
    description: 'An older way of downloading email, which usually removes messages from the server once they are fetched.',
  ...
  143: {
    ...
    protocol: 'IMAP',
    category: 'mail',
    description: 'Reading email that stays stored on the mail server, so it remains in sync across your devices.',
  ...
  1025: {
    ...
    category: 'mail',
    description: 'A fake mail server for development. It accepts the email your app sends and holds it, instead of delivering it to real people.',
  ...
  22: {
    ...
    description: 'SSH, the standard encrypted way to log into a machine and run commands on it from somewhere else. It also carries Git traffic and secure file copies.',
    context: 'Normal on servers and on developer machines with remote access switched on. Worth checking if you did not enable it.',
  ...
  23: {
    ...
    protocol: 'Telnet',
    category: 'remote-access',
    description: 'An obsolete way of logging into a machine remotely. It sends passwords as readable text.',
    context: 'Should not normally be running. If you did not enable it deliberately, it is worth turning off.',
  ...
  3389: {
    ...
    protocol: 'RDP',
    category: 'remote-access',
    description: 'Windows Remote Desktop, which lets someone see and control this computer as if they were sitting at it.',
    context: 'Normal on managed work machines. If you did not switch Remote Desktop on yourself, it is worth checking.',
  ...
  5985: {
    ...
    protocol: 'WinRM',
    category: 'remote-access',
    description: 'The channel IT tools and PowerShell use to run commands on this machine remotely.',
  ...
  20: {
    ...
    description: 'The channel classic FTP uses to move the actual file contents. Port 21 carries the commands.',
  ...
  21: {
    ...
    protocol: 'FTP',
    category: 'file-transfer',
    description: 'The classic File Transfer Protocol, used to upload and download files from a server.',
    context: 'Everything including the password travels unencrypted. If you did not start an FTP server on purpose, it is worth turning off.',
  ...
  69: {
    ...
    protocol: 'TFTP',
    category: 'file-transfer',
    description: 'A stripped-down file transfer service, mostly used to start devices up over a network.',
  ...
  445: {
    ...
    protocol: 'SMB',
    category: 'file-transfer',
    description: 'How Windows shares folders and printers across a network. Also how network drives are reached.',
    context: 'Normal on Windows and on any machine hosting shared folders. It should never be reachable from the internet.',
  ...
  88: {
    ...
    protocol: 'Kerberos',
    category: 'directory',
    description: 'Kerberos, the ticket-based login system behind Windows domains and many corporate networks.',
  ...
  389: {
    ...
    protocol: 'LDAP',
    category: 'directory',
    description: 'LDAP, the service that answers "who is this user and what are they allowed to do" for company networks.',
  ...
  1883: {
    ...
    context: 'Normal if you run a home automation hub or an IoT project. Unencrypted; port 8883 is the secure version.',
  ...
  4222: {
    ...
    protocol: 'NATS',
    category: 'messaging',
    description: 'NATS, a fast messaging system that lets separate services send events to each other.',
  ...
  5672: {
    ...
    category: 'messaging',
    description: 'RabbitMQ, which holds jobs and messages in a queue so applications can work through them in the background.',
  ...
  15672: {
    ...
    category: 'messaging',
    description: 'The web dashboard for inspecting RabbitMQ queues and the messages waiting in them.',
  ...
  9092: {
    ...
    category: 'messaging',
    description: 'Apache Kafka, which records a continuous stream of events that many services can read at their own pace.',
  ...
  2181: {
    ...
    category: 'messaging',
    description: 'ZooKeeper, which keeps a group of servers agreeing on shared settings. It often runs next to Kafka.',
  ...
  2375: {
    ...
    description: 'The Docker engine accepting commands over the network without encryption. Anything that can reach it can start containers on this machine.',
    context: 'Always switched on deliberately, never by default. It grants full control of the machine, so it should only ever be reachable locally.',
  ...
  2376: {
    ...
    category: 'infrastructure',
    description: 'The Docker engine accepting commands over an encrypted, certificate-checked connection.',
  ...
  2379: {
    ...
    category: 'infrastructure',
    description: 'etcd, the store that holds the configuration and current state of a Kubernetes cluster.',
  ...
  6443: {
    ...
    category: 'infrastructure',
    description: 'The Kubernetes API server, which every "kubectl" command talks to. Local clusters such as k3s and Docker Desktop use it too.',
  ...
  8200: {
    ...
    category: 'infrastructure',
    description: 'Vault, which stores passwords, API keys, and certificates and hands them out to applications that are allowed to have them.',
  ...
  8500: {
    ...
    category: 'infrastructure',
    description: 'Consul, which keeps track of where each service is running so the others can find it.',
    context: 'Normal in a microservice setup.',
  ...
  9090: {
    ...
    protocol: 'Prometheus',
    category: 'infrastructure',
    description: 'Prometheus, which regularly collects numbers about how systems are performing and stores them for graphing.',
  ...
  9093: {
    ...
    category: 'infrastructure',
    description: 'The component that decides when a monitoring alert should actually notify someone.',
  ...
  9100: {
    ...
    category: 'infrastructure',
    description: 'Publishes this machine CPU, memory, and disk figures so a monitoring system can read them.',
  ...
  3100: {
    ...
    category: 'infrastructure',
    description: 'Loki, which gathers log lines from applications so they can be searched in Grafana.',
    context: 'Normal in a monitoring setup.',
  ...
  5601: {
    ...
    protocol: 'Kibana',
    category: 'infrastructure',
    description: 'Kibana, the web dashboard for searching and charting data stored in Elasticsearch.',
    context: 'Normal alongside Elasticsearch.',
  ...
  16686: {
    ...
    protocol: 'Jaeger',
    category: 'infrastructure',
    description: 'Jaeger, a web page showing how a single request travelled through your services and where the time went.',
  ...
  4317: {
    ...
    category: 'infrastructure',
    description: 'Where applications send their metrics, logs, and traces using the OpenTelemetry standard.',
  ...
  4318: {
    ...
    category: 'infrastructure',
    description: 'The HTTP version of the OpenTelemetry intake, used by browser and mobile clients.',
    context: 'Normal in a modern monitoring setup.',
    aliases: ['otlp', 'opentelemetry', 'otel', 'traces'],
  },
  902: {
  ...
  53: {
    ...
    protocol: 'DNS',
    category: 'system',
    description: 'DNS, which turns website names into the numeric addresses computers actually use. A listener here is usually a local cache or a container network.',
    context: 'Normal on machines running Docker, a VPN, or a local DNS tool such as Pi-hole or dnsmasq.',
  ...
  67: {
    ...
    context: 'Normal on routers, and on a machine sharing its connection or running virtual machines.',
  ...
  123: {
    ...
    protocol: 'NTP',
    category: 'system',
    description: 'Keeps this computer clock accurate by checking it against time servers on the internet.',
  ...
  135: {
    ...
    protocol: 'MS RPC',
    category: 'system',
    description: 'The Windows service that tells programs which port another Windows service is currently using.',
  ...
  161: {
    ...
    protocol: 'SNMP',
    category: 'system',
    description: 'SNMP, used by monitoring tools to read the status of printers, switches, and servers.',
    context: 'Normal on network equipment, unusual on a laptop.',
  ...
  631: {
    ...
    protocol: 'IPP / CUPS',
    category: 'system',
    description: 'The printing system, which manages print queues and finds printers on the network.',
  ...
  5040: {
    ...
    category: 'system',
    description: 'A built-in Windows service that links this PC with your phone and other devices, powering features such as Nearby Sharing.',
  ...
  5353: {
    ...
    category: 'system',
    description: 'How devices announce themselves on a local network using ".local" names. It sits behind AirPlay, AirDrop, Chromecast, and printer discovery.',
  ...
  7680: {
    ...
    category: 'system',
    description: 'Lets this PC download Windows updates from other PCs nearby instead of only from Microsoft servers.',
